...
public class QrCodeScannerDriver extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void onCreate(Bundle state) {
        ...
        Dexter.withActivity(this).withPermission(Manifest.permission.CAMERA).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse response) {
                mScannerView.setResultHandler(QrCodeScannerDriver.this);
  ...
  /*  @Override
    ...
    public void handleResult(com.google.zxing.Result result) {
        ...
        result_intent.putExtra("driverNO",result.getText());
