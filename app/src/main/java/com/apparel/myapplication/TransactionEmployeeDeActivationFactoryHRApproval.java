...
public class TransactionEmployeeDeActivationFactoryHRApproval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Deactivation Approval 1");
        ...
        lbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_data = getData.loadDeactivationhrapprovals(locid);
               ...
               /* try {
                ...
                TableRow head_row = new TableRow(TransactionEmployeeDeActivationFactoryHRApproval.this);
                TextView id_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView empid_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView name_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView desig_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView depname_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView dateadded_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView remark_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView islevel1_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView islevel2_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView islevel3_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView isblacklisted_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                TextView deactpk_head = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                ...
                try {
                    ...
                    while (load_data.next()) {
                        ...
                        final TableRow data_row = new TableRow(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        TextView id_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView empid_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView name_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView desig_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView depname_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView dateadded_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView remark_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        final CheckBox data_check = new CheckBox(getApplicationContext());
                        ...
                        TextView islevel1_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView islevel2_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView islevel3_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView isblacklisted_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        ...
                        TextView deackpk_view = new TextView(TransactionEmployeeDeActivationFactoryHRApproval.this);
                        deackpk_view.setText(appk);

                        deackpk_view.setLayoutParams(textViewParam);
                        deackpk_view.setGravity(Gravity.CENTER_VERTICAL);
                        deackpk_view.setTypeface(null, Typeface.BOLD);
                        deackpk_view.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
                        deackpk_view.setVisibility(View.INVISIBLE);
            ...
            public void onClick(View v) {
              ...
              if (dpks.size() != 0) {
                    ...
                    for (int i = 0; i < dpks.size(); i++) 
                    {
                       ...
                       co= getData.hrDeactivationApprove(dpks.get(i), id);
                        if(co>0)
                      {
                            flag=flag+1;
                        }
                  ...
                  if (flag == dpks.size()) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(TransactionEmployeeDeActivationFactoryHRApproval.this);
        ...
        rbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dpks.size() != 0) {
                    ...
                    for (int i = 0; i < dpks.size(); i++)
                    {
                        co= getData.hrDeactivationrejecta(dpks.get(i), 1);
                        if(co>0)
                        {
                            flag=flag+1;
                        }
