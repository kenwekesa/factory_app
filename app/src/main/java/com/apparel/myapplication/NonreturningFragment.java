 ...
 */
public class NonreturningFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";

    private int SCAN_REQUESTCODE = 98;
    int empID,userPK, employee_designationPK, locationPK, hh;
    String empid;
    ...
    public static NonreturningFragment newInstance(String param1, String param2) {
        NonreturningFragment fragment = new NonreturningFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview= inflater.inflate(R.layout.fragment_nonreturning, container, false);
